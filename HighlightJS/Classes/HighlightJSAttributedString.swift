...
open class HighlightJSAttributedString : NSTextStorage {
    /// Internal Storage
    ...
    open let highlightJS = HighlightJS()!
    
    /// This object will be notified before and after the highlighting.
    open var highlightDelegate : HighlightJSDelegate?
    ...
    func highlight(_ range: NSRange) {
        ...
        DispatchQueue.global().async {
            let tmpStrg = self.highlightJS.highlight(line, as: self.language!)
